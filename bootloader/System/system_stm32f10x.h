...
#define NVIC_PriorityGroup_0 (0 << 8)
#define NVIC_PriorityGroup_1 (1 << 8)
#define NVIC_PriorityGroup_2 (2 << 8)
#define NVIC_PriorityGroup_3 (3 << 8)
#define NVIC_PriorityGroup_4 (4 << 8)
